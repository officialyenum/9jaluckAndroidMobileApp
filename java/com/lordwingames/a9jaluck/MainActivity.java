    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.nav_home:
                    Intent i = new Intent(MainActivity.this, Splash2Activity.class);
                    startActivity(i);
                    break;
                case R.id.nav_games:
                    Intent j = new Intent(MainActivity.this, GameActivity.class);
                    startActivity(j);
                    break;
                case R.id.nav_promo:
                    Intent k = new Intent(MainActivity.this, promoActivity.class);
                    startActivity(k);
                    break;
            }
            return false;
